            ...
            <div className="asolas">
                <div className="info">
                    ...
                    <span>
                        ...
                        Whatsapp: <a href="https://api.whatsapp.com/send?phone=5492615618566" className="url_wsp">+54 9 261 561-8566</a>
                    </span>
                </div>
                <div>
                ...
                <div className="redes">
                    <a href="https://www.instagram.com/asolassexshop/"><img src={insta} alt="logo instagram" className="insta"/></a>
                    <a href="https://api.whatsapp.com/send?phone=5492615618566"><img src={wsp} alt="logo wsp" className="wsp_2"/></a>
                    <a href=""><img src={tiktok} alt="logo tiktok" className="tiktok"/></a>
                </div>
            </div>
